...
<header>
  ...
  <script>
    function afficherLSTD(id)
    {
      ...
      ajax.open('GET', 'https://www.blexisgame.com/PageListeDt.php?id=' + id, true);
...
<?php
  require('/var/www/www.blexisgame.com/administration/accesseur/ProjetDAO.php');
...
?>
  ...
  <div class="d-grid gap-2 btn-1">
    <button class="btn btn-lg btn-primary" onclick="previous(getId())">jeu precedent</button>
  </div>
  ...
  <div class="achat">
    ...
    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
          ...
          <input type="hidden" name="notify_url" value="https://www.blexisgame.com/IPN/testReception.php">
          <input type="hidden" name="return" value="https://www.blexisgame.com/">
  ...
  <div class="d-grid gap-2 btn-2">
    <button class="btn btn-lg btn-primary" onclick="next(getId())">jeu suivant</button>
  </div>
  </div>
</body>
